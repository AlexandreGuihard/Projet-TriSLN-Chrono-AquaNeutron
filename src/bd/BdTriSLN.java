...
public class BdTriSLN{
    ...
    /**
     * Getter pour avoir la connexion
     * @return le connexionMySQL de la bd
     */
    ...
    public List<Participant> getParticipantsCourseRelais() throws SQLException{
        ...
        while(participants.next()){
            try{
                ...
                Participant participant = new ParticipantCourseRelais(idP, nom, prenom, idCategorie, sexe, email, ville, certification, tel, dateNaissance, licence, nomEquipe);
                // chronometre manque un constructeur qui prend en compte chrono TODO
