...
(1, "Dupont", "carle", "MP","F","x.carle@yahoo.fr","Paris",TRUE,0647882565,"SQL",1,TO_DATE('15-JUN-2001','DD-MON-YYYY'),"bleu",TRUE)
...
(5, "Dupont", "dupon", "MP","F","x.dupon@yahoo.fr","Paris",TRUE,0647882565,"SQL",1,TO_DATE('15-JUN-2001','DD-MON-YYYY'),"noire",TRUE)
; 
